...
[![x-cmd/install — s3cmd Code Quality Monitoring Repo Card](https://repo.x-cmd.io/s3cmd.svg?lang=zh)](https://x-cmd.com/install/s3cmd)
...
- **Star**: 4,907 · **Fork**: 903 · **开放 issue**: 936 · **贡献者**: 172
...
_数据快照: `data/card/260920.yml` · 2026-09-20T06:01:37Z._
